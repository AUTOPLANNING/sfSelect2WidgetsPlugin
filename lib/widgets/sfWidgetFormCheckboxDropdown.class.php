...
/**
 * Compact dropdown with checkboxes for multiselect filtering (Doctrine model choices).
 * Renders as a button that opens an overlay dropdown with search and checkboxes.
 */
class sfWidgetFormCheckboxDropdown extends sfWidgetFormDoctrineChoice
{
